...
const (
	...
	GreetService_SayHelloBiredirectionalStreaming_FullMethodName = "/greet_service.GreetService/SayHelloBiredirectionalStreaming"
)
...
type GreetServiceClient interface {
	...
	SayHelloBiredirectionalStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HelloRequest, HelloResponse], error)
}
...
func (c *greetServiceClient) SayHelloBiredirectionalStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HelloRequest, HelloResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], GreetService_SayHelloBiredirectionalStreaming_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloBiredirectionalStreamingClient = grpc.BidiStreamingClient[HelloRequest, HelloResponse]
...
type GreetServiceServer interface {
	...
	SayHelloBiredirectionalStreaming(grpc.BidiStreamingServer[HelloRequest, HelloResponse]) error
...
func (UnimplementedGreetServiceServer) SayHelloBiredirectionalStreaming(grpc.BidiStreamingServer[HelloRequest, HelloResponse]) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloBiredirectionalStreaming not implemented")
}
...
func _GreetService_SayHelloBiredirectionalStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloBiredirectionalStreaming(&grpc.GenericServerStream[HelloRequest, HelloResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloBiredirectionalStreamingServer = grpc.BidiStreamingServer[HelloRequest, HelloResponse]
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SayHelloBiredirectionalStreaming",
			Handler:       _GreetService_SayHelloBiredirectionalStreaming_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
