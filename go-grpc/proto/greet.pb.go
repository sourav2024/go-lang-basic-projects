...
const file_proto_greet_proto_rawDesc = "" +
	...
	"\x17SayHelloClientStreaming\x12\x1b.greet_service.HelloRequest\x1a\x1b.greet_service.MessagesList(\x01\x12a\n" +
	" SayHelloBiredirectionalStreaming\x12\x1b.greet_service.HelloRequest\x1a\x1c.greet_service.HelloResponse(\x010\x01B\tZ\a./protob\x06proto3"
...
var file_proto_greet_proto_depIdxs = []int32{
	...
	1, // 3: greet_service.GreetService.SayHelloBiredirectionalStreaming:input_type -> greet_service.HelloRequest
	...
	2, // 7: greet_service.GreetService.SayHelloBiredirectionalStreaming:output_type -> greet_service.HelloResponse
